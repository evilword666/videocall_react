...
class VideoRoomComponent extends Component {
    constructor(props) {
        ...
        */
        ...
        let sessionName = this.props.sessionName ? this.props.sessionName : roomNameXD;
        let userName = this.props.user ? this.props.user : 'TM_User_' + Math.floor(Math.random() * 100);
        //let userName = this.props.user ? this.props.user : userNameXD;
